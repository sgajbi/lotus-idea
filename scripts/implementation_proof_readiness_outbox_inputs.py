...
def outbox_proof_artifact_inputs(
    ...
    return {
        "outbox_broker_source_contract_proof": proof_artifact_input(
        ...
        "outbox_broker_runtime_execution_proof": proof_artifact_input(
        ...
        "outbox_consumer_contract_proof": proof_artifact_input(
        ...
        "outbox_consumer_runtime_execution_proof": proof_artifact_input(
        ...
        "outbox_platform_mesh_event_source_contract_proof": proof_artifact_input(
