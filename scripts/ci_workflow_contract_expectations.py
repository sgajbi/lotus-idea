...
WORKFLOW_EXPECTATIONS: dict[str, tuple[str, ...]] = {
    ...
    "feature-lane.yml": (
        ...
        "scripts/ci_signal_evidence.py --needs-env CI_NEEDS_JSON",
    ...
    "main-releasability.yml": (
        ...
        "durable-repository-certification-proof",
        "output/persistence/durable-repository-proof.json",
        "output/persistence/durable-repository-ci-execution-receipt.json",
        "actions/download-artifact@3e5f45b2cfb9172054b4087a40e8e0b5a5461e7c # v8.0.1",
        "docker/setup-buildx-action@d7f5e7f509e45cec5c76c4d5afdd7de93d0b3df5 # v4.1.0",
        ...
        "GHCR authentication failed after ${auth_attempts} attempts",
        "GHCR authentication attempt ${auth_attempt}/${auth_attempts} failed; retrying after ${auth_retry_delay_seconds}s",
    ...
    "merged-pr-main-releasability.yml": (
        ...
        '"$merge_methods" != "false,false,true"',
...
PROHIBITED_WORKFLOW_PATTERNS: dict[str, tuple[str, ...]] = {
    ...
    "merged-pr-main-releasability.yml": ("continue-on-error:", "--ref main"),
    "scheduled-data-lifecycle-review.yml": (
        "continue-on-error:",
        "pull_request_target:",
        "contents: write",
