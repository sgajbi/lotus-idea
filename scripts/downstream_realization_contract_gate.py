...
from app.application.downstream_realization.intake_wire_contract_gate import (  # noqa: E402
    DOWNSTREAM_INTAKE_WIRE_CONTRACT_PATH as DOWNSTREAM_INTAKE_WIRE_CONTRACT_PATH,
    validate_downstream_intake_wire_contract as _validate_downstream_intake_wire_contract,
)
