...
posture has 111 tracked RFC-0002 issues, 86 closed and 25 open, and the current
live cross-repo RFC-0002 posture is 180 label-backed RFC-0002 issues across 13
repositories: 143 closed and 37 open. The open set is 25 `status/blocked`, 1
`status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 8
`status/tracker` issues; this includes #681 as the in-progress issue, while
#1024, #1027, and #1029 are QA-closed Slice 19 hardening issues. Blocked actionability
...
`31268949391` passing.
Current Idea ledger posture has 111 tracked RFC-0002 issues, 86 closed and 25
...
is 180 label-backed RFC-0002 issues across 13 repositories: 143 closed and 37 open.
The open split is 25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 8 `status/tracker`. The
...
has 111 tracked RFC-0002 issues, 86 closed and 25 open. Current live posture is 25
...
issue outside the Idea ledger, and 1 in-progress RFC-0002 issue
(`sgajbi/lotus-idea#681`). The full live posture is 180 label-backed RFC-0002
issues across 13 repositories: 143 closed and 37 open. The open split is 25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 8 `status/tracker`.
