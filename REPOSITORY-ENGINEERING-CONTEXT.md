...
repositories: 140 closed and 40 open. The open set is 25 `status/blocked`, 2
`status/in-progress` (#681 and #1029), 2 `status/merged-main` including #1024, 2
...
`sgajbi/lotus-idea#1029` is in progress for the Slice 19 configured proof-artifact
...
open. The open split is 25 `status/blocked`, 2 `status/in-progress`, 2
...
140 closed and 40 open. The open split is 25 `status/blocked`, 2
`status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, and
8 `status/tracker`.
