...
Slice 18 in-progress issue and #1059 has PR #1060 open for the Slice 15/19 outbox proof consumer refactor, #1056 is a QA-closed Slice 12 downstream
...
across 13 repositories: 151 closed and 38 open. The open set is 25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, 8 `status/tracker` issues; this includes #681 as the
in-progress issue and #1059 as the PR-open issue, while #1024, #1044,
...
open; `sgajbi/lotus-idea#681` is the in-progress Slice 18 tracker, `sgajbi/lotus-idea#1059` has PR #1060 open for the Slice 15/19 outbox proof consumer refactor,
...
(`sgajbi/lotus-idea#681`), with `sgajbi/lotus-idea#1059` PR-open for Slice 15/19 outbox proof consumer hardening; `sgajbi/lotus-idea#1056` is QA-closed for the
