...
posture has 119 tracked RFC-0002 issues, 94 closed and 25 open; #681 is the
Slice 18 in-progress issue, #1056 is a QA-closed Slice 12 downstream
...
across 13 repositories: 151 closed and 37 open. The open set is 25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 0 `status/pr-open`, 8 `status/tracker` issues; this includes #681 as the
...
`31268949391` passing.
Current Idea ledger posture has 119 tracked RFC-0002 issues, 94 closed and 25
...
repositories: 151 closed and 37 open.
...
has 119 tracked RFC-0002 issues, 94 closed and 25 open. Current live posture is 25
...
(`sgajbi/lotus-idea#681`); `sgajbi/lotus-idea#1056` is QA-closed for the
...
across 13 repositories: 151 closed and 37 open.
