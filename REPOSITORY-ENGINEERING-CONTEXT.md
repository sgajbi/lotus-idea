...
owner-mainline evidence contract. A valid aggregate-current artifact may clear
only `workbench_gateway_bff_consumption_proof_missing`; it must preserve
production identity, browser accessibility, canonical demo runtime,
data-product, client-publication, suitability/execution, and supported-feature
blockers.
