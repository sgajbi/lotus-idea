...
def source_ref(product_id: str, freshness: str = "current") -> dict[str, Any]:
    return lotus_core_source_ref(product_id, freshness=freshness)
...
def persist_headers(idempotency_key: str) -> dict[str, str]:
    return {
        ...
        "X-Correlation-Id": "corr-candidate-persist-api",
        "X-Trace-Id": "trace-candidate-persist-api",
