...
from app.api.outbox_delivery_readiness import _count_bucket
...
def test_outbox_delivery_operation_count_buckets_are_bounded() -> None:
    ...
    assert _count_bucket(1) == "1-10"
    assert _count_bucket(10) == "1-10"
    assert _count_bucket(11) == "11-100"
    assert _count_bucket(100) == "11-100"
    assert _count_bucket(101) == "100+"
