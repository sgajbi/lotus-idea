...
from app.api.low_income_signals import EvaluateLowIncomeSignalResponse
...
def test_low_income_examples_cover_every_domain_outcome_and_authority_boundary() -> None:
    caller_examples = build_low_income_evaluation_response_examples()
    source_examples = build_source_backed_low_income_evaluation_response_examples()
    ...
    assert all(
        EvaluateLowIncomeSignalResponse.model_validate(example)
...
def test_low_income_examples_match_ledger_and_generated_openapi() -> None:
    expected_by_path = {
        LOW_INCOME_EVALUATE_OPERATION_PATH: build_low_income_evaluation_response_examples(),
        LOW_INCOME_EVALUATE_FROM_SOURCE_OPERATION_PATH: (
            build_source_backed_low_income_evaluation_response_examples()
        ),
    }
