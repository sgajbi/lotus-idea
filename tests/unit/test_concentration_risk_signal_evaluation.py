...
def test_concentration_source_correction_preserves_candidate_and_versions_evidence() -> None:
    source_input = concentration_input()
    assert source_input.concentration_ref is not None
    ...
    original = evaluate_concentration_risk_signal(source_input, policy())
    corrected = evaluate_concentration_risk_signal(corrected_input, policy())
