...
def test_drawdown_source_correction_preserves_candidate_and_versions_evidence() -> None:
    ...
    original = evaluate_drawdown_review_signal(source_input, policy())
    corrected = evaluate_drawdown_review_signal(corrected_input, policy())
