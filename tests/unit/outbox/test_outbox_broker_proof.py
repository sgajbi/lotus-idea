...
from app.application.outbox.broker_proof import (
...
def _load_generator_script() -> ModuleType:
    script_path = ROOT / "scripts" / "outbox" / "generate_broker_proof.py"
...
def _load_contract_gate_script() -> ModuleType:
    script_path = ROOT / "scripts" / "outbox" / "broker_proof_contract_gate.py"
