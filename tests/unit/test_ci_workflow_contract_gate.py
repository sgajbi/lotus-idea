...
def test_ci_contract_gate_blocks_split_dispatch_run_steps(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_split_unnamed_dispatch_run_step(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_trailing_dispatch_ref_creation(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_masked_releasability_dispatch_failure(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_nested_releasability_dispatch_command(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_masked_dispatch_ref_creation_failure(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_backgrounded_dispatch_ref_creation(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_chained_dispatch_ref_creation_command(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_allows_explicit_post_dispatch_ref_creation_method(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_input_body_dispatch_ref_creation_override(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_dispatch_before_ref_creation(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_blocks_function_scoped_dispatch_ref_lookup_guard(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
...
def test_ci_contract_gate_binds_dispatch_ref_payload_to_creation_command(
    tmp_path: Path,
) -> None:
    module = _load_ci_contract_gate()
    workflow_dir = _copy_workflows(tmp_path)
