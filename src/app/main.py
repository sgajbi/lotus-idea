...
from app.api.presentation_receipts import register_presentation_receipt_routes
...
from app.api.examples.bond_maturity_signal import apply_bond_maturity_signal_openapi_examples
...
from app.api.examples.downstream_submission import apply_downstream_submission_openapi_examples
...
def _register_product_routes(application: FastAPI) -> None:
    ...
    register_presentation_receipt_routes(application)
