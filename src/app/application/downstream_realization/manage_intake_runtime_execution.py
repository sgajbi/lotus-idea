...
def source_safe_manage_receipt_digest(receipt: Mapping[str, Any]) -> str:
    canonical = {
        ...
        "actionRegisterCreated": receipt.get("actionRegisterCreated"),
        "rebalanceExecutionAuthorityGranted": receipt.get("rebalanceExecutionAuthorityGranted"),
...
def _receipt_matches(
    ...
    *,
    ...
    return (
        ...
        and value.get("receiptDigest") == source_safe_manage_receipt_digest(value)
        and value.get("actionRegisterCreated") is False
        and value.get("rebalanceExecutionAuthorityGranted") is False
