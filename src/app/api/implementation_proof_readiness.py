...
async def get_implementation_proof_readiness(
    ...
    try:
        require_capability(caller, _READ_IMPLEMENTATION_PROOF_READINESS_POLICY)
...
IMPLEMENTATION_PROOF_READINESS_ROUTE: RouteMetadata = {
    ...
    "description": (
        ...
        "promotion. It does not expose candidate identifiers, source payloads, Workbench "
        "proof, data-product certification, client-ready publication, or a supported feature."
    ),
