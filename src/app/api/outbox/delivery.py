...
from app.api.outbox.delivery_models import (
...
from app.application.outbox.delivery import (
...
OUTBOX_DELIVERY_RUN_ONCE_ROUTE: RouteMetadata = {
    ...
    "description": (
        ...
        "observed downstream consumer execution and platform-mesh event publication evidence, "
