            ...
            "content": {
                "application/json": {
                    "example": {
                        ...
                        "configuredScheduledWorkerSourceContractAvailable": False,
                        "scheduledWorkerSourceContractValid": False,
                        "configuredScheduledWorkerDeploymentEvidenceAvailable": False,
                        "scheduledWorkerDeploymentEvidenceValid": False,
