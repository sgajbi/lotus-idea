...
async def evaluate_allocation_drift_signal(
    ...
    return evaluate_caller_supplied_signal(
        ...
        evaluator=evaluate_mandate_health_signal_command,
...
ALLOCATION_DRIFT_EVALUATE_ROUTE: RouteMetadata = {
    ...
    "responses": {
        200: {
            "description": "Allocation-drift signal evaluation completed with candidate, blocked, or not-eligible posture.",
            "content": {
                "application/json": {
                    "example": {
