...
implementation-proof-readiness-check:
	...
	$(VENV_PYTHON) scripts/downstream_realization/generate_advise_intake_runtime_execution.py --generated-at-utc $(IMPLEMENTATION_PROOF_EVALUATED_AT_UTC) --advise-root $(LOTUS_ADVISE_ROOT) --advise-python $(LOTUS_ADVISE_PYTHON) --output $(LOTUS_IDEA_ADVISE_INTAKE_RUNTIME_EXECUTION_PROOF_OUTPUT)
