...
implementation-proof-readiness-check:
	...
	$(VENV_PYTHON) scripts/workbench/generate_contract_proof.py --generated-at-utc $(IMPLEMENTATION_PROOF_EVALUATED_AT_UTC) --workbench-read-path-proof output/workbench/workbench-read-path-proof.json --output $(LOTUS_IDEA_GATEWAY_WORKBENCH_CONTRACT_PROOF_OUTPUT)
	...
	$(VENV_PYTHON) scripts/workbench/generate_discovery_contract_proof.py --generated-at-utc $(IMPLEMENTATION_PROOF_EVALUATED_AT_UTC) --platform-root $(LOTUS_PLATFORM_ROOT) --platform-mesh-onboarding-proof $(LOTUS_IDEA_PLATFORM_MESH_ONBOARDING_PROOF_OUTPUT) --workbench-read-path-proof output/workbench/workbench-read-path-proof.json --gateway-workbench-contract-proof $(LOTUS_IDEA_GATEWAY_WORKBENCH_CONTRACT_PROOF_OUTPUT) --output $(LOTUS_IDEA_GATEWAY_WORKBENCH_DISCOVERY_CONTRACT_PROOF_OUTPUT) --allow-missing-evidence
