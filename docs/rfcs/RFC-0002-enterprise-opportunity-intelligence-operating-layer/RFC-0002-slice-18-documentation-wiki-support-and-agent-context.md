...
`status/ready`, 9 `status/tracker`; `sgajbi/lotus-idea#681` is in progress,
`#1145` is closed after PR #1149 exact-main and wiki proof, and `#1150` is
ready for the adjacent Slice 08 ownership correction. The
