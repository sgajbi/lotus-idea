...
| 9 | Governed AI explanation and model-risk controls | Partially implemented - internal AI governance, governed workflow-pack allowlist, certified API foundation, source-safe lineage persistence, and not-certified readiness diagnostic | redacted AI request envelopes, fallback/verifier API, source-safe lineage record, safe audit, no-authority proof, `lotus-ai:idea-explanation:v1` request identity mapped to `idea_explanation.pack@v1` proof identity; `lotus-ai` runtime execution remains planned |
