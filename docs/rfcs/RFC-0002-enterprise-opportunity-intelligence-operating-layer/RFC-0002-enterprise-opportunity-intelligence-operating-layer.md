...
| 3 | Opportunity domain model, vocabulary, and lifecycle | Implemented foundation; `idea-opportunity-identity-v2` and explicit evidence/material/reopen vocabulary are merged and exact-main validated through issue `#1154` and PR `#1157` | pure domain model, lifecycle tests, unsupported transition behavior, and issue `#1154` identity invariants |
