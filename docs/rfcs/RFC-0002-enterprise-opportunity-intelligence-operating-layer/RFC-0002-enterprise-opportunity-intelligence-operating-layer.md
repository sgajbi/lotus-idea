...
| 2 | Cleanup, structure, and current surface normalization | Partially implemented - runtime composition providers normalized behind the API runtime dependency facade and architecture-boundary enforcement retained | dead-code/doc-sprawl cleanup, module boundaries, vocabulary baseline, runtime composition boundary proof |
