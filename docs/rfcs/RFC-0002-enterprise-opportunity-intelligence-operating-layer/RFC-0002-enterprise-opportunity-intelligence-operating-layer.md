...
| Missing or stale risk profile | `lotus-advise`; client facts from `lotus-core` | Advice or review is blocked because risk profile is missing, stale, or incompatible. | Partially implemented - deterministic evidence-gap policy and bounded Advise policy-evaluation diagnostic consumption only; typed Advise risk-profile source product, live proof, data-mesh certification, Workbench proof, client publication, and supported promotion remain blocked |
| Mandate or restriction review | `lotus-core`; `lotus-manage`; `lotus-advise` | Mandate, restriction, or suitability context blocks or changes actionability. | Partially implemented - deterministic source-ref-preserving policy, bounded caller-supplied API foundation, typed Advise restriction source-product proof, and separate Advise live-proof contract exist; data-mesh certification, Workbench proof, client publication, restriction-clearance authority, mandate-state authority, and supported promotion remain blocked |
...
| 9 | Governed AI explanation and model-risk controls | Partially implemented - internal AI governance, governed workflow-pack allowlist, signed Lotus AI run-attestation verification, durable replay protection, certified API foundation, source-safe lineage persistence, v2 source-contract classification for registration and model-risk operations evidence, and not-certified readiness diagnostic | redacted AI request envelopes, fallback/verifier/attested-output API, bounded verified receipt, safe audit, no-authority proof, `lotus-ai:idea-explanation:v1` request identity mapped to `idea_explanation.pack@v1` proof identity; source contracts clear no runtime blocker, and runtime registration, dashboard/alert runtime, mainline cross-repository, and live-provider proof remain blocked |
...
| 12 | Advise and Manage conversion realization | Partially implemented - internal conversion governance, source-versioned outcomes, durable claim-before-call submission and operator reconciliation, certified APIs, source-safe adapters, readiness diagnostics, governed contract gates, and bounded route-foundation proof consumption | Advise/Manage intent handoff now preserves uncertain outcomes without automatic retry and exposes audited source-safe recovery. Suitability/rebalance authority, live downstream execution, source-owned outcome proof, Gateway/Workbench product proof, and supported product promotion remain planned. |
...
| 14 | Data-product promotion, trust telemetry, and platform hardening | Partially implemented - internal not-certified mesh readiness, runtime telemetry preview, API-certified runtime snapshot diagnostic, generated source-safe runtime snapshot evidence, and runtime telemetry proof contract plus digest-bound mesh policy source-contract evidence | repo-native declarations, readiness diagnostic, runtime telemetry preview, runtime snapshot endpoint, generated runtime snapshot, runtime telemetry proof contract, blocked static trust telemetry, SLO/access/evidence policies; product promotion remains planned |
| 15 | Observability, security, entitlements, and operations | Partially implemented - bounded operation events plus readiness diagnostics, scheduled-worker proof posture, and source/outbox delivery run-once operator eventing with source-safe run identity | operation-event metric/log vocabulary, no-sensitive-label proof, endpoint instrumentation including candidate evidence replay, source-ingestion run-once, scheduled-worker proof validity, downstream submission, downstream-realization readiness, source-ingestion readiness, outbox-delivery readiness/run-once with operator-run replay/conflict posture, advisor-queue readiness, AI explanation readiness, data-mesh readiness, and aggregate implementation-proof readiness diagnostics; broader runbooks, certified long-running scheduling proof, and production telemetry remain planned |
...
| 17 | Implementation proof and live validation | Partially implemented - aggregate proof-readiness diagnostic and repo-native artifact generation include bounded live-source ingestion proof, scheduled-worker deploy-proof consumption, durable repository proof consumption, runtime trust telemetry proof consumption, Workbench read-path source-contract proof consumption, Gateway/Workbench contract proof consumption, Gateway/Workbench discovery contract proof consumption, bounded outbox broker source-contract proof consumption, default Advise proposal route proof consumption, default Manage action route proof consumption, default Report intake route and materialization source-contract consumption, default digest-bound mesh policy source-contract supporting-evidence consumption, default platform catalog source contract consumption, AI lineage store proof consumption, AI workflow-pack registration/runtime execution proof consumption, and optional Risk concentration, high-volatility, drawdown, Performance underperformance, missing-benchmark Performance readiness, Core benchmark assignment, Core portfolio-state, Manage mandate, and Advise missing-suitability live-proof consumption; full live journey proof remains pending | machine-readable proof blocker index exists through certified operator API and `make implementation-proof-readiness-check`, including source-safe bounded live-source, scheduled-worker deploy-proof artifact generation/consumption, durable repository proof artifact generation/consumption, runtime telemetry proof artifact generation/consumption, Workbench read-path source-contract proof artifact generation/consumption, Gateway/Workbench contract proof artifact generation/consumption, Gateway/Workbench discovery contract proof artifact generation/consumption, outbox broker source-contract proof artifact generation/consumption without runtime blocker clearance, Advise proposal route proof artifact generation/consumption, Manage action route proof artifact generation/consumption, Manage mandate live-proof consumption, Core portfolio-state live-proof consumption, Report intake route and materialization source-contract generation/consumption without runtime blocker clearance, mesh policy source-contract artifact generation/consumption without certification-blocker clearance, platform catalog source contract artifact generation/consumption, AI lineage store proof artifact generation/consumption, AI workflow-pack registration/runtime execution proof artifact generation/consumption, and Risk/Performance/Core/Manage/Advise live-proof artifact consumption that clears only the named opportunity-archetype source blockers; 2026-07-05 live canonical proof cleared only Risk concentration, Performance underperformance, and missing-benchmark Performance readiness source blockers for `PB_SG_GLOBAL_BAL_001`; full live canonical end-to-end evidence and critical result review remain planned |
| 18 | Documentation, wiki, support, and agent context | Partially implemented - API certification, implementation-proof, live-source, scheduled-worker, durable repository proof, runtime trust telemetry proof, Workbench read-path source-contract proof, downstream route proof, Manage mandate live proof, Core portfolio-state live proof, outbox broker source-contract proof, mesh policy source-contract evidence, AI lineage store proof, AI workflow-pack proof, and outbox delivery documentation synchronized | README/wiki/context/runbook updates, API certification guide, implementation-proof-readiness guide, downstream-realization guide, persistence guide, source-ingestion runbook, scheduled-worker proof boundaries, durable repository proof boundary, runtime telemetry proof boundary, Workbench read-path source-contract proof boundary, Advise/Manage/Report route proof boundaries, Manage mandate proof boundary, Core portfolio-state proof boundary, outbox broker source-contract proof boundary, mesh policy source-contract boundary, AI lineage store proof boundary, AI workflow-pack registration/runtime execution proof boundary, outbox delivery boundaries, client-demo process, and wiki source updates; wiki check-only remains required before merge |
