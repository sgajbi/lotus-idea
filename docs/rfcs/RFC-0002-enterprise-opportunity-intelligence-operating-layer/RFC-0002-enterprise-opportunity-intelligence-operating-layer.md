...
| 6 | Persistence, replay, idempotency, and audit | Partially implemented - internal persistence plus idempotent lifecycle and high-cash orchestration foundations only | internal records, hashes, replay posture, audit events, idempotent high-cash persist and lifecycle transition orchestration; database persistence remains planned |
