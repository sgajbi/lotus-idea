...
| 6 | Persistence, replay, idempotency, and audit | Partially implemented - internal persistence, replay/audit, durable claim-before-call downstream submission recovery, source-safe operator reconciliation, outbox retry/dead-letter/re-drive, migration execution, PostgreSQL adapters, real logical backup/restore and resume proof, provider-restore validation, recovery-aware write gating, and bounded broker/consumer/mesh proof foundations | versioned schema/rollback through migration `008`; candidate/review/feedback/conversion/report persistence; source ingestion and outbox recovery; opaque support references; lease-fenced finalize; uncertain-outcome quarantine; certified reconciliation APIs; enforced call ordering; real PostgreSQL concurrency/restart/connection-failure proof; and a weekly attested 15-table restore drill. Physical/WAL provider certification, retention/legal-hold/erasure closure, live source certification, certified external publication, downstream execution/materialization, Gateway/Workbench product proof, and supported promotion remain planned. |
