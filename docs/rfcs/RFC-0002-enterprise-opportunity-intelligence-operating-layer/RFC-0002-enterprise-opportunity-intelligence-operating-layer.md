...
| 6 | Persistence, replay, idempotency, and audit | Implemented foundation; economic-identity reconciliation and migration `016` are merged and exact-main validated through issue `#1154` and PR `#1157`. Repository-owned persistence, replay/audit, lifecycle controls, durable downstream recovery, operator reconciliation, outbox delivery/recovery, PostgreSQL adapters, and recovery proof remain in place. | Schema/rollback through migration `016`; complete Idea-owned workflow persistence; equivalent evidence refresh, material version, recurrent reopen, identity-conflict and concurrency fencing; recovery-aware writes; real PostgreSQL restart/concurrency/logical-restore proof; and protected exact-image migration controls. Managed infrastructure, external authority, live production certification, publication, Gateway/Workbench product proof, and supported promotion remain fail-closed under issues `#340`, `#343`-`#345`, `#375`, and `#378`-`#380`. |
