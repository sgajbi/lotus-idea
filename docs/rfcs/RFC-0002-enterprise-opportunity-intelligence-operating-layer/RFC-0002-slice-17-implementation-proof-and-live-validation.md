...
34. `src/app/application/core_portfolio_state_live_proof.py`,
    ...
    a source-safe Lotus Core portfolio-state live-proof artifact. Aggregate
    readiness can consume a valid artifact to clear only
