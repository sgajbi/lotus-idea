...
| 5 | [Deterministic Signal Evaluation And Candidate Generation](RFC-0002-enterprise-opportunity-intelligence-operating-layer/RFC-0002-slice-05-deterministic-signal-evaluation-and-candidate-generation.md) | Partially implemented - high-cash domain policy plus Core source-port and bounded run-once ingestion worker foundation |
