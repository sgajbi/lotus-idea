...
| 5 | [Deterministic Signal Evaluation And Candidate Generation](RFC-0002-enterprise-opportunity-intelligence-operating-layer/RFC-0002-slice-05-deterministic-signal-evaluation-and-candidate-generation.md) | Partially implemented - high-cash domain policy plus Core source-port, concentration-risk domain policy plus Risk source-port/adapter foundation, underperformance domain policy plus Performance returns-series source-port/adapter foundation, manifest-backed run-once ingestion worker, and scheduled-worker deploy-contract foundation |
