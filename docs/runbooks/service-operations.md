...
| `make implementation-proof-readiness-check` | Scheduled-worker deploy, durable repository, runtime telemetry, Workbench read-path, default report-intake route, and RFC-0002 aggregate proof-readiness evidence. |
