...
| --- | --- |
| GitHub issue posture | 126 RFC-0002 issues: 88 closed, 38 open. |
...
| Latest Idea closure truth | `lotus-idea#864` and `#866` are closed and now ledgered as RFC-0002 Slice 17/19 hardening issues. |
