...
downstream consumer runtime proof generated by
`scripts/outbox/generate_consumer_runtime_proof.py` and guarded by
`make outbox-consumer-runtime-proof-contract-gate`; that artifact clears only
