...
`scripts/generate_outbox_consumer_runtime_proof.py` and guarded by
...
`scripts/generate_outbox_platform_mesh_event_publication_proof.py` and guarded
...
artifact, Manage mandate live proof artifact, Core benchmark assignment live
