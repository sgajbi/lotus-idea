...
flowchart LR
    ...
    Open["140 closed and 39 open<br/>25 `status/blocked`, 2 `status/in-progress`, 2 `status/merged-main`<br/>2 `status/merged-to-main`, 8 trackers"]
...
| `status/in-progress` | 2 | Continuous Slice 18 synchronization tracker `sgajbi/lotus-idea#681` plus Slice 19 test-maintainability refactor `sgajbi/lotus-idea#1027`. |
...
label-backed RFC-0002 issues, 140 closed and 39 open, with 25 `status/blocked`, 2 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`,
