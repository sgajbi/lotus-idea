...
| Active synchronization tracker | `sgajbi/lotus-idea#681`; `sgajbi/lotus-idea#1059` is in progress for Slice 15/19 outbox proof consumer hardening; `sgajbi/lotus-idea#1056` is closed after Slice 12 downstream submission API orchestration reached exact main and QA; `sgajbi/lotus-idea#1044`, `sgajbi/lotus-idea#1037`, `sgajbi/lotus-idea#1040`, `sgajbi/lotus-idea#1047`, `sgajbi/lotus-idea#1049`, and `sgajbi/lotus-idea#1052` are QA-closed Slice 19 hardening issues |
...
flowchart LR
    ...
    Open["151 closed and 38 open<br/>25 `status/blocked`, 0 `status/fixed-local`, 2 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 0 `status/pr-open`, 8 `status/tracker`"]
...
| `status/in-progress` | 2 | Continuous Slice 18 synchronization tracker `sgajbi/lotus-idea#681` plus in-progress Slice 15/19 outbox proof consumer refactor `sgajbi/lotus-idea#1059`. |
...
| `status/pr-open` | 0 | No current RFC-0002 issue has an open PR lifecycle label. |
