...
flowchart LR
    ...
    Open["167 closed and 38 open<br/>25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, 8 `status/tracker`"]
...
| `status/pr-open` | 1 | Slice 19 supported-feature gate fixture refactor `sgajbi/lotus-idea#1104` has open PR #1105. |
...
PR-open for Slice 19 supported-feature gate fixture hardening; `lotus-idea#1101` is
