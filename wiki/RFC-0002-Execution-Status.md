...
| Active synchronization tracker | `sgajbi/lotus-idea#681`; `sgajbi/lotus-idea#1044` is PR-open through `sgajbi/lotus-idea#1045` for the Slice 12/13/19 conversion outcome persistence maintainability refactor; `sgajbi/lotus-idea#1037` and `sgajbi/lotus-idea#1040` are QA-closed Slice 19 hardening issues |
...
flowchart LR
    ...
    Open["146 closed and 38 open<br/>25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, 8 `status/tracker`"]
...
| `status/pr-open` | 1 | Active Slice 12/13/19 maintainability refactor `sgajbi/lotus-idea#1044` is under PR `sgajbi/lotus-idea#1045`. |
