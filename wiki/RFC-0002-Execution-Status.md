...
| Active synchronization tracker | `sgajbi/lotus-idea#681`; `sgajbi/lotus-idea#1059` has PR #1060 open for Slice 15/19 outbox proof consumer hardening; `sgajbi/lotus-idea#1056` is closed after Slice 12 downstream submission API orchestration reached exact main and QA; `sgajbi/lotus-idea#1044`, `sgajbi/lotus-idea#1037`, `sgajbi/lotus-idea#1040`, `sgajbi/lotus-idea#1047`, `sgajbi/lotus-idea#1049`, and `sgajbi/lotus-idea#1052` are QA-closed Slice 19 hardening issues |
...
flowchart LR
    ...
    Open["151 closed and 38 open<br/>25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, 8 `status/tracker`"]
...
| `status/pr-open` | 1 | Slice 15/19 outbox proof consumer refactor `sgajbi/lotus-idea#1059` has PR #1060 open. |
