...
| Engineering and agents | The dated 2026-08-30 baseline tracks 242 label-backed RFC-0002 issues across 13 repositories: 204 closed and 38 open, with 25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/ready`, 9 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger baseline tracks 151 RFC-0002 issues: 124 closed and 27 open. Live GitHub execution has advanced: `#1155` has its Idea-owned feedback/evaluation foundation on exact main and `#1156` is actively implementing effectiveness and presentation-receipt evidence; both remain open for consumer and certification proof. | Complete the issue-backed consumer and certification evidence, keep GitHub state durable, and rerun canonical QA before any support promotion. |
