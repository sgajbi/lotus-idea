...
| Engineering and agents | As of 2026-08-30, 237 label-backed RFC-0002 issues are tracked across 13 repositories: 200 closed and 37 open, with 25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 1 `status/pr-open`, 9 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 146 RFC-0002 issues: 120 closed and 26 open, with `sgajbi/lotus-idea#681` in progress and `#1139` PR-open in PR #1146 for Slice 18 synchronization and live posture enforcement; `#1119`, `#1121`, `#1123`, `#1125`, `#1127`, `#1129`, and `#1131` are closed after Slice 17 release-governance hardening. | Fix writable blockers when discovered, keep GitHub state durable, and rerun canonical QA before closure. |
