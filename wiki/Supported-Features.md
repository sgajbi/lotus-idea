...
| Engineering and agents | 200 label-backed RFC-0002 issues are tracked across 13 repositories: 163 closed and 37 open, with 25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 0 `status/pr-open`, 8 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 131 RFC-0002 issues: 106 closed and 25 open, with `sgajbi/lotus-idea#681` in progress and `#1088` closed after PR #1089 reached exact main. | Fix writable blockers when discovered, keep GitHub state durable, and rerun canonical QA before closure. |
