...
| Engineering and agents | The dated 2026-08-30 baseline tracks 237 label-backed RFC-0002 issues across 13 repositories: 200 closed and 37 open, with 25 `status/blocked`, 2 `status/in-progress`, 1 `status/merged-main`, 9 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 146 RFC-0002 issues: 120 closed and 26 open, with `sgajbi/lotus-idea#681` and `#1139` in progress for Slice 18 synchronization and non-regressive live posture enforcement; `#1119`, `#1121`, `#1123`, `#1125`, `#1127`, `#1129`, and `#1131` are closed after Slice 17 release-governance hardening. | Fix writable blockers when discovered, keep GitHub state durable, and rerun canonical QA before closure. |
