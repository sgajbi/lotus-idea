...
| Engineering and agents | 203 label-backed RFC-0002 issues are tracked across 13 repositories: 165 closed and 38 open, with 25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, 8 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 134 RFC-0002 issues: 108 closed and 26 open, with `sgajbi/lotus-idea#681` open as the Slice 18 synchronization tracker, `#1098` in progress for release-CI hardening, and `#1094` closed after PR #1095 reached exact main. | Fix writable blockers when discovered, keep GitHub state durable, and rerun canonical QA before closure. |
