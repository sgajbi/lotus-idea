...
| Engineering and agents | The dated 2026-08-30 baseline tracks 242 label-backed RFC-0002 issues across 13 repositories: 204 closed and 38 open, with 25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/ready`, 9 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 151 RFC-0002 issues: 124 closed and 27 open. `sgajbi/lotus-idea#681` remains the synchronization tracker, `#1154` is closed after PR #1157 exact-main/release/wiki/branch proof, and `#1155` then `#1156` are ready for feedback-quality and effectiveness measurement. | Complete issue-backed work in that order, keep GitHub state durable, and rerun canonical QA before any support promotion. |
