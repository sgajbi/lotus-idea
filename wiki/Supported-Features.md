...
| Engineering and agents | 200 label-backed RFC-0002 issues are tracked across 13 repositories: 162 closed and 38 open, with 25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, 8 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 131 RFC-0002 issues: 105 closed and 26 open, with `sgajbi/lotus-idea#681` in progress and `#1088` PR-open in PR #1089; PR #1087 synchronized the latest mainline source/docs/wiki posture. | Fix writable blockers when discovered, keep GitHub state durable, and rerun canonical QA before closure. |
