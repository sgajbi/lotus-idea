...
| Engineering and agents | 234 label-backed RFC-0002 issues are tracked across 13 repositories: 197 closed and 37 open, with 25 `status/blocked`, 0 `status/fixed-local`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 0 `status/pr-open`, 8 `status/tracker`, and 0 app-actionable blocked issues. The Idea source ledger tracks 145 RFC-0002 issues: 120 closed and 25 open, with `sgajbi/lotus-idea#681` open as the Slice 18 synchronization tracker and `#1119`, `#1121`, `#1123`, `#1125`, `#1127`, `#1129`, and `#1131` closed after Slice 17 release-governance hardening. | Fix writable blockers when discovered, keep GitHub state durable, and rerun canonical QA before closure. |
