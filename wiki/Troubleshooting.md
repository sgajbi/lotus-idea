...
| Source-ingestion readiness is blocked | `GET /api/v1/source-ingestion/readiness` | Manifest, durable repository posture, Core source configuration, receipt-bound runtime evidence, scheduled-worker proof. |
