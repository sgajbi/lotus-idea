...
`sgajbi/lotus-idea#1091` is PR-open through PR #1092, and `sgajbi/lotus-idea#1088`,
...
#1091 is PR-open through PR #1092, #1088, #1084, #1082, and #1080 are the latest closed Idea maintainability hardening issues, while #681 is in progress;
