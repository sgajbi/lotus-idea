...
repositories: 142 closed and 38 open. The open split is 25 `status/blocked`,
1 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, 8
`status/tracker`; `sgajbi/lotus-idea#1024` is the remaining merged-main
QA-pending Slice 19 test-maintainability issue, `sgajbi/lotus-idea#1027` and
`sgajbi/lotus-idea#1029` are closed after QA-backed Slice 19 maintainability
hardening, and `sgajbi/lotus-idea#681` is the in-progress Slice 18 issue.
...
180 label-backed RFC-0002 issues across 13 repositories: 142 closed and 38 open.
The open set is 25 `status/blocked`, 1 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, 8 `status/tracker`;
#1024 is the remaining merged-main QA-pending Slice 19 test-maintainability issue, #1027 and #1029 are closed after QA-backed Slice 19 hardening, and #681 is the in-progress Slice 18 issue;
