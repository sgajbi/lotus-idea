...
repositories: 143 closed and 37 open. The open split is 25 `status/blocked`,
...
180 label-backed RFC-0002 issues across 13 repositories: 143 closed and 37 open.
The open set is 25 `status/blocked`, 1 `status/in-progress`, 1 `status/merged-main`, 2 `status/merged-to-main`, 8 `status/tracker`;
#1024, #1027, and #1029 are closed after QA-backed Slice 19 hardening, and #681 is the in-progress Slice 18 issue;
