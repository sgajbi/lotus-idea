...
`sgajbi/lotus-idea#1037` is the fixed-local Slice 19 Core benchmark runtime evidence
...
#1024, #1027, #1029, and #1033 are closed after QA-backed Slice 19 hardening, #681 is the in-progress Slice 18 issue, and #1037 is the fixed-local Slice 19 validator refactor;
