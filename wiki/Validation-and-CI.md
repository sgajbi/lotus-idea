...
| Supported-feature claim | `make supported-features-gate`, `make implementation-truth-gate`, `make implementation-proof-closure-manifest-gate` | No unproved support or certification language; every proof blocker has issue and evidence-class closure truth. |
