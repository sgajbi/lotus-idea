...
Current live posture is 179 label-backed RFC-0002 issues across 13
repositories: 140 closed and 39 open. The open split is 25 `status/blocked`, 1 `status/fixed-local`, 1 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, and 8 `status/tracker`;
`sgajbi/lotus-idea#1024` is merged-main QA-pending, `sgajbi/lotus-idea#1027` is the fixed-local Slice 19 test-maintainability issue, and `sgajbi/lotus-idea#681` is the in-progress Slice 18 issue.
...
179 label-backed RFC-0002 issues across 13 repositories: 140 closed and 39 open.
The open set is 25 `status/blocked`, 1 `status/fixed-local`, 1 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, and 8 `status/tracker`;
#1024 is merged-main QA-pending, #1027 is the fixed-local Slice 19 test-maintainability issue, and #681 is the in-progress Slice 18 issue;
