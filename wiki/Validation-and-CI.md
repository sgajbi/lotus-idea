...
repositories: 140 closed and 39 open. The open split is 25 `status/blocked`, 1 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, and 8 `status/tracker`;
`sgajbi/lotus-idea#1024` is merged-main QA-pending, `sgajbi/lotus-idea#1027` has PR #1028 open for Slice 19 test maintainability, and `sgajbi/lotus-idea#681` is the in-progress Slice 18 issue.
...
The open set is 25 `status/blocked`, 1 `status/in-progress`, 2 `status/merged-main`, 2 `status/merged-to-main`, 1 `status/pr-open`, and 8 `status/tracker`;
#1024 is merged-main QA-pending, #1027 has PR #1028 open for Slice 19 test maintainability, and #681 is the in-progress Slice 18 issue;
