...
closure evidence. Every open RFC-0002 issue must have exactly one governed
`status/*` lifecycle label. Generate current counts with
`make rfc0002-github-issue-execution-summary`; do not rewrite the dated ledger
solely because an issue moved, closed, or reopened.
