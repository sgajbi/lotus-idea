...
4. extend the current Core source-port foundation into live high-cash /
   ...
   weight,
5. broaden the current PostgreSQL high-cash persistence/replay proof into
   source ingestion workers, durable queue state, review, feedback,
   conversion, report evidence-pack, and recovery proof,
