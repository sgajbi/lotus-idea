...
| Opportunity archetypes | A governed archetype/scenario contract identifies high cash / idle liquidity as the first partially implemented journey, records concentration risk review, underperformance review, allocation drift / mandate review, bond maturity / reinvestment, high-volatility / drawdown review, missing suitability context, missing risk-profile review, mandate/restriction review, missing-benchmark review, and low-income / liquidity shortfall as non-promoted bounded foundations, keeps remaining unimplemented archetypes planned, and is visible as blocked scenario readiness in aggregate proof readiness. Valid source-safe live proof artifacts can clear only the high-cash live Core blocker, concentration live Risk blocker, high-volatility live Risk volatility blocker, Risk drawdown source blocker, underperformance live Performance blocker, Core benchmark assignment source-ref blocker, missing-benchmark live Core source blocker, low-income Core cashflow source blocker, Manage mandate portfolio-scoped source blocker, missing-suitability live Advise source blocker, and missing risk-profile live Advise source blocker where proof contracts exist. Underperformance currently consumes source-reported active return and benchmark context from `lotus-performance:ReturnsSeriesBundle:v1`; valid Core benchmark assignment proof clears only the benchmark-assignment source-ref blocker while data-mesh, Workbench, client-publication, and supported-feature blockers remain. Missing-benchmark review consumes only Core-owned benchmark-assignment posture; valid missing-benchmark Core proof clears only the live Core source blocker while Performance benchmark-readiness, benchmark-assignment authority, methodology, return-calculation, data-mesh, Workbench, client-publication, and supported-feature blockers remain. Allocation drift currently consumes `lotus-manage:PortfolioActionRegister:v1` action-register supportability posture; valid Manage mandate live proof clears only the portfolio-scoped Manage source blocker while mandate performance-health, mandate risk-health, Core portfolio-state, data-mesh, Workbench, client-publication, supported-feature, rebalance, action, and order-execution blockers remain. Bond maturity / reinvestment currently has deterministic review-candidate policy and Core source-port shape only; because Core maturity-bearing HoldingsAsOf/live proof is not yet certified, data-mesh, Workbench, client-publication, product-recommendation, reinvestment-advice, and supported-feature blockers remain. High-volatility / drawdown review currently consumes Risk-owned `RiskMetricsReport:v1` volatility and `DrawdownAnalyticsReport:v1` maximum drawdown; data-mesh, Workbench, client-publication, and supported-feature blockers remain. Missing suitability context currently consumes Advise-owned `AdvisoryPolicyEvaluationRecord:v1` workflow posture to create only a compliance-review candidate for open suitability, disclosure, consent, approval, or sign-off context; a valid live Advise proof clears only the live-source blocker while data-mesh, Workbench, client-publication, and supported-feature blockers remain. Missing risk-profile review currently consumes only explicit Advise-owned risk-profile diagnostic posture; a valid live Advise proof clears only the risk-profile live-source blocker while typed source product, Workbench, data-mesh, client-publication, and supported-feature blockers remain. Mandate/restriction review currently exposes a bounded caller-supplied API and deterministic policy for explicit source-owned restriction posture; live upstream source proof, typed restriction source products, Workbench, data-mesh, client-publication, suitability approval, restriction clearance, mandate change authority, and supported-feature blockers remain. Low-income / liquidity shortfall currently consumes Core-owned `PortfolioCashflowProjection:v1` and `PortfolioCashMovementSummary:v1` only to create an advisor-review candidate when projected cumulative cashflow crosses a deterministic threshold; valid Core cashflow proof clears only the live Core cashflow source blocker while Workbench, data-mesh, client-publication, supported-feature, suitability, planning, funding-advice, and treasury-instruction blockers remain. | Use as taxonomy, source-authority framing, and internal foundation proof only; do not present it as full Workbench journey proof, client-demo proof, or a supported feature. |
