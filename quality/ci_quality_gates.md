...
payload projection into `app.ports.evidence_payloads`; the current measured baseline scans 1,617
functions and reports 10 exact duplicate clusters. The CI contract gate protects the target wiring,
