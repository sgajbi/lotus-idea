...
| --- | --- | --- |
| Opportunity policies | Bounded foundations exist for high cash, concentration risk, underperformance, allocation drift, bond maturity, volatility, drawdown, suitability gaps, risk-profile gaps, mandate/restriction review, income gaps, and missing benchmark review. Mandate/restriction review now has a closed, receipt-bound Advise runtime-evidence contract that accepts truthful candidate and no-opportunity outcomes and fails closed on untrusted producer scope or time. | Advise must still publish authoritative scope/time metadata; typed source-product, data-mesh, Workbench, client-publication, deployment, production, and supported-feature certification remain blocked. |
