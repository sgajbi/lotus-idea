...
| --- | --- | --- |
| Opportunity policies | Bounded foundations exist for high cash, concentration risk, underperformance, allocation drift, bond maturity, volatility, drawdown, suitability gaps, risk-profile gaps, mandate/restriction review, income gaps, and missing benchmark review. Missing-suitability, missing-risk-profile, and mandate/restriction review have closed, receipt-bound Advise runtime-evidence contracts that accept truthful candidate and no-opportunity outcomes and fail closed on untrusted producer scope, time, hashes, or workflow posture. | Advise must still publish authoritative scope/time metadata; typed source-product, data-mesh, Workbench, client-publication, deployment, production, and supported-feature certification remain blocked. |
