...
| `make api-problem-details-boundary-gate`, `make openapi-problem-details-example-gate`, `make signal-api-contract-gate` | Block direct API route imports from `app.errors`, missing public `ProblemDetails` OpenAPI examples, and duplicated caller-supplied signal API permission, source-authority, 400/403 examples, and operation-event mechanics. |
