...
| `make mandate-restriction-live-proof-contract-gate` | Validate the source-safe Lotus Advise mandate/restriction live-proof artifact contract that can clear only the live restriction source blocker when explicit source-owned restriction diagnostics are present. |
