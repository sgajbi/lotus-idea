...
| `make core-benchmark-assignment-live-proof-contract-gate` | Validate the source-safe Lotus Core benchmark assignment live-proof artifact contract that can clear only the underperformance-review benchmark-assignment source-ref blocker when valid evidence is supplied. |
