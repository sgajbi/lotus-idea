...
- `src/app/domain/`: framework-free domain models, policies, scoring,
  ...
  records, idempotency, replay, audit primitives, outbox records, claim/lease
  fencing, retry/dead-letter semantics, and public domain API exports guarded by `make private-import-boundary-gate`.
